...
export class NotificationsController {
  ...
  @Patch('set-as-read/notification/:id')
  async setUserNotificationAsRead(@Param('id') idNotification: string) {
    return await this.notificationsServices.setUserNotificationAsRead(
      idNotification,
    );
  }
}
