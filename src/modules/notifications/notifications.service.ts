...
export class NotificationService {
  ...
  //     // console.log('text', allUserNotifications);
  ...
  //       ...createNotificationsDto,
  //       user: {
  //         id: createNotificationsDto.userId,
  //       },
  //     });

  //     notificationToSave.createdBy = EnumNotificationCreator.system;
  ...
  async setUserNotificationAsRead(idNotification: string) {
    try {
      const notification = await this.notificationsRepository.update(
        idNotification,
        {
          readAt: new Date(),
          status: EnumStatus.read,
        },
      );
